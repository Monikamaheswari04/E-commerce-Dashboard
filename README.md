...
- Product listing is client-only (no API pagination)  
- Images are local (ensure assets exist or use CDN)  
...
# License & Contact
Free to use for learning or assessments.  
Add MIT/Apache license if releasing publicly.  
